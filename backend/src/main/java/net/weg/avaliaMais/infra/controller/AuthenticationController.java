...
public class AuthenticationController {
    ...
    public ResponseEntity<LoginResponseDTO> login(@RequestBody @Valid AuthenticationRequestDTO authenticationRequestDTO,
        ...
        cookie.setPath("/");                // O cookie será acessível em toda a aplicação
        cookie.setMaxAge(60 * 60);          // Expiração de 1 hora
        cookie.setSecure(false);            // Defina para true se usar HTTPS
        cookie.setDomain("localhost");      // Certifique-se de que o domínio está configurado corretamente para seu ambiente de desenvolvimento
