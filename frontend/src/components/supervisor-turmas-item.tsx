...
interface SupervisorTurmasItemProps {
  id: number
  name: string
  students: number
  time: string
...
export function SupervisorTurmasItem({ id, name, students, time, color }: SupervisorTurmasItemProps) {
  return (
    <Link href={`/supervisor/alunos-supervisor`}>
