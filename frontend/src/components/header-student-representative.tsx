...
export default function Header() {
  ...
  useEffect(() => {
    setNotifications([
      {
        id: 1,
        title: "Prazo para formulário de pré-conselho",
        message: "O formulário de pré-conselho da turma 3A deve ser preenchido até sexta-feira",
        time: "há 2 horas",
        read: false,
        type: "deadline",
      ...
      {
        id: 2,
        title: "Reunião de pré-conselho marcada",
        message: "A reunião de pré-conselho foi agendada para 25/05 às 14h",
        time: "ontem",
        read: true,
        type: "meeting",
      ...
      {
        id: 3,
        title: "Formulário de avaliação pendente",
        message: "Você tem 3 formulários de avaliação de colegas para preencher",
        time: "há 3 dias",
        read: true,
        type: "form",
      ...
      {
        id: 4,
        title: "Lembrete: Coleta de feedback",
        message: "Não esqueça de coletar o feedback dos colegas para o próximo conselho",
        time: "há 1 semana",
        read: true,
        type: "reminder",
    ...
    <div>
      <header className="flex items-center justify-between p-4 bg-[#003366] text-white relative z-10">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Link for Avatar */}
          <Link href="/student-representative/perfil-student-representative">
            <Avatar className="h-10 w-10 border-2 border-white cursor-pointer">
            <AvatarImage src="/gustavo.png" alt="Gustavo" />
