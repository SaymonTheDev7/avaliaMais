...
import SidebarAdministrator from "@/components/sidebar-administrator"
...
export default function Header() {
    ...
    return (
        <div>
            <header className="flex items-center justify-between p-4 bg-[#003366] text-white relative z-10">
                ...
                <div className="flex items-center gap-4">
                                ...
                                <div className="max-h-96 overflow-y-auto">
                                    {notifications.length === 0 ? (
                                        ...
                                        notifications.map(notification => (
                                            <div
                                                key={notification.id}
                                                className={`group p-4 transition border-b last:border-none ${!notification.read ? 'bg-blue-50' : 'bg-white'
                                                    } hover:bg-gray-50`}
                                            >
                                                <div className="flex justify-between items-start">
                                                    <div className="flex-1 pr-2">
                                                        <div className="flex items-center gap-2 mb-1">
                                                            <span className={`text-xs font-semibold px-2 py-0.5 rounded-full capitalize ${notification.type === "deadline"
                    ...
                    <Avatar className="h-10 w-10 border-2 border-white cursor-pointer">
                        <AvatarImage src="/admin.png" alt="Gustavo" />
            ...
            {isSidebarOpen && <SidebarAdministrator onClose={closeSidebar} />}
        </div>
    )
}
