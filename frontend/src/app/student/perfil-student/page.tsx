        ...
        <div className="relative mt-8">
          ...
          <Card className="pt-16 pb-8 px-6 rounded-3xl bg-white border border-gray-100 shadow-sm">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-6">
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-gray-900">André Felipe Witt</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-700">
                    "O André sempre apoia nossas aulas de Front-End com orientações precisas e estratégias práticas para melhorar o engajamento dos alunos."
                  </p>
            ...
            <Card className="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-700">
                    "A atuação do André tem sido essencial nas disciplinas de Java. Ele consegue alinhar bem teoria e prática com o suporte pedagógico necessário."
                  </p>
                  <p className="mt-3 text-sm text-gray-500 font-medium">
                    Prof. de Java
                  </p>
            ...
            <Card className="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-700">
                    "Com André, conseguimos estruturar melhor os projetos de banco de dados, promovendo maior integração entre teoria e prática."
                  </p>
                  <p className="mt-3 text-sm text-gray-500 font-medium">
            ...
            <Card className="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-700">
                    "André sempre colabora ativamente nas discussões sobre redes, trazendo soluções viáveis para desafios enfrentados em sala."
                  </p>
                  <p className="mt-3 text-sm text-gray-500 font-medium">
                    Prof. de Redes
                  </p>
