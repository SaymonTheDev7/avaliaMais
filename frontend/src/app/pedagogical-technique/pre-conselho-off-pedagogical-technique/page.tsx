...
export default function PreConselhoPage() {
  ...
  const handleIniciarPreConselho = () => {
    setShowConfirmation(true)
  }

  const handleConfirmIniciarPreConselho = () => {
    router.push("/pedagogical-technique/pre-conselho-pedagogical-technique")
  }
  ...
  return (
    <div className="flex flex-col h-screen bg-white">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center mb-6 px-4">
          ...
          <div className="ml-auto mt-4 sm:mt-0 hidden sm:block">
            <button
              ...
              onClick={handleIniciarPreConselho}
            >
      ...
      <ConfirmationDialog
        ...
        onConfirm={handleConfirmIniciarPreConselho}
        title="Iniciar Pré-Conselho"
        message="Tem certeza que deseja iniciar o pré-conselho?"
