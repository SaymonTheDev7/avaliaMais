...
export default function PreConselhoPage() {
  ...
  const handleFinalizarPreConselho = () => {
    setShowConfirmation(true)
  }

  const handleConfirmFinalizarPreConselho = () => {
    // Redirecionar para a página do conselho geral com o caminho correto
    router.push("/pedagogical-technique/conselho-geral-pedagogical-technique")
  }
  ...
  return (
    <div className="flex flex-col h-screen bg-white">
      ...
      <div className="p-4 md:p-6 flex-1 ml-2 md:ml-6 lg:ml-10 mr-2 md:mr-6 lg:mr-10 mt-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center mb-6 px-4">
          ...
          <div className="ml-auto mt-4 sm:mt-0 hidden sm:block">
            <button
              className="bg-[#003366] hover:bg-[#005099] text-white px-4 py-2 rounded-md sm:text-xl transition duration-200"
              onClick={handleFinalizarPreConselho}
            >
        ...
        <div className="flex justify-center mb-4 sm:hidden">
          <button
            className="bg-[#003366] hover:bg-[#005099] text-white px-4 py-2 rounded-md text-lg transition duration-200 w-4/5 max-w-xs"
            onClick={handleFinalizarPreConselho}
          >
            Finalizar pré conselho
          </button>
      ...
      <ConfirmationDialog
        ...
        onConfirm={handleConfirmFinalizarPreConselho}
        title="Finalizar Pré-Conselho"
        message="Tem certeza que deseja finalizar o pré conselho? Após isso o conselho geral será iniciado."
