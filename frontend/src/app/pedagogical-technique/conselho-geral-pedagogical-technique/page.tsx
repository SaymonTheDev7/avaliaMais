...
import { ConselhoGeralItem } from "@/components/conselho-geral-item"
...
export default function ConselhoGeralPage() {
  ...
  const handleConfirmFinalizarConselho = () => {
    // Redirecionar para a página inicial ou outra página após finalizar o conselho
  ...
  return (
    <div className="flex flex-col h-screen bg-white">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center mb-6 px-4">
          ...
          <div className="ml-auto mt-4 sm:mt-0 hidden sm:block">
            <button
              ...
              onClick={handleFinalizarConselho}
            >
              Finalizar conselho
            </button>
          </div>
      ...
      {/* Diálogo de confirmação para finalizar o conselho geral */}
      <ConfirmationDialog
        isOpen={showConfirmation}
        onClose={() => setShowConfirmation(false)}
        onConfirm={handleConfirmFinalizarConselho}
        title="Finalizar Conselho Geral"
        message="Tem certeza que deseja finalizar o conselho geral?"
