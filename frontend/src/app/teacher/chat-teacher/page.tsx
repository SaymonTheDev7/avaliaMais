...
export default function ChatInterface() {
    const [messages, setMessages] = useState([
        { id: 1, sender: 'contact', text: 'Olá, compareça na sala dos professores às 14:00, teremos uma pequena reunião.', time: 'Hoje, 9:32', read: true },
        { id: 2, sender: 'user', text: 'Bom dia Juci, vou conseguir ir, porém, irei me atrasar um pouco pois irei passar uma avaliação para a MI74, obrigado.', time: 'Hoje, 9:32', read: true },
        { id: 3, sender: 'contact', text: 'Ok, venha quando conseguir pois a reunião é importante.', time: 'Hoje, 9:32', read: true },
        { id: 4, sender: 'user', text: 'Beleza, quando eu terminar de passar as instruções eu passo ai.', time: 'Hoje, 9:32', read: true },
    ]);
